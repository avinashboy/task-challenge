                            ...
                            <div className="card shadow mb-4">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>You can create more custom buttons by adding a new color variable in the
                                        ...
                                        file.</p>
                                    <a  className="btn btn-google btn-block"><i className="fab fa-google fa-fw"></i>
                                        .btn-google</a>
                                    <a  className="btn btn-facebook btn-block"><i
                        ...
                        <div className="col-lg-6">
                            ...
                            <div className="card shadow mb-4">
                                ...
                                <div className="card-body">
                                    ...
                                    <a  className="btn btn-primary btn-icon-split btn-sm">
                                        <span className="icon text-white-50">
                                            <i className="fas fa-flag"></i>
                                        </span>
                                    ...
                                    <div className="my-2"></div>
                                    <a  className="btn btn-primary btn-icon-split btn-lg">
                                        <span className="icon text-white-50">
                                            <i className="fas fa-flag"></i>
                                        </span>
